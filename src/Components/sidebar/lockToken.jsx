...
function LockToken() {
  ...
  const approve = async () => {
    try {
      setLoading(true);
      let TOKENCONTRACT = new ethers.Contract(TOKEN, TOKENABI, signerData);
      console.log(amount);
      let locktokenamount = ethers.utils.parseUnits(
        amount.toString(),
        "ethers"
      );
  ...
  function Mains1() {
    return (
      <>
        ...
        >
          <div>{tokenName} Lock Details</div>
          {/* <div>
          0.0% Locked
        </div> */}
        </div>
        ...
        >
          <div>
            ...
            <div style={{ paddingTop: "2vw", paddingBottom: "2vw" }}>
              Total Locked Token
            </div>
            <div style={{ paddingTop: "2vw", paddingBottom: "2vw" }}>
              Tokens to be locked
      ...
      <>
        ...
        >
          ...
          <div>
            ...
            <div style={{ color: "#525252", paddingTop: "2vw" }}>{amount}</div>
            <div style={{ color: "#525252", paddingTop: "2vw" }}>
              <input
                value={newtoken}
        ...
        <div style={{ color: "#525252" }}>
          (Relock only applicable if current lock period is over)
        </div>
            ...
            >
              ...
              <div>
                ...
                <div
                  ...
                  style={{ color: "#2D5C8F", paddingTop: "2vw" }}
                >
                  <svg
                    width="17"
                    height="20"
  ...
  return (
    <>
      ...
      <div
        className="locktoken"
        style={{ ...blurryDivStyle, padding: "2%", margin: "0 12% 0 15%" }}
      >
        <div className="lockTokenFirstRow" style={{ width: "100%" }}>
          ...
          <div
            className="lockTokenFirstRow_1"
            style={{ paddingLeft: "20px", width: "70%" }}
          >
            <div
              style={{
                padding: "0",
