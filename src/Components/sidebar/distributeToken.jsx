            ...
            <div style={{ padding: "0 2%" }}>
                ...
                <div className="tokenBody" style={{ padding: "2%" }}>
                    ...
                    <div className="tokenSettings" style={{ width: "45%", backgroundColor: "transparent", border: "0", borderLeft: "1px solid" }}>
                        ...
                        <div style={{ color: `${theme === 'Dark' ? 'white' : 'black'}` }}>Upload CSV                         
                        <a target="_blank" style={{ color: `${theme === 'Dark' ? 'white' : 'black'}` }} href="https://docs.google.com/spreadsheets/d/10zBcQ1lS_10mnFi2NC8xkhlLmPhqAb2Qxz2RGUNI0QA/edit?usp=sharing">( Sample CSV )</a>
                        </div>
