    ...
    <div className="mainpage">
      ...
      <div className="sidebar" id='sidebar2' style={{ backgroundColor: `${theme === 'Dark' ? '#101010' : 'whitesmoke'}` }}>
        <Link to='/'><div style={{ paddingTop: '1.389vw' }} className='expanded_2' onClick={() => {
          ...
          <img id='logo_1' src={Icon} style={{ width: '3.2vw', height: '3.2vw' }} alt="" />
        ...
        <div style={{ paddingTop: '1.62vw', display: 'flex', flexDirection: 'column', height: '70%', justifyContent: 'space-between' }}>
          <Link to='/'>
            <div className='expanded' style={{ marginTop: '15px' }} onClick={() => {
              ...
              <svg style={{ width: '100%', marginRight: '2px', fill: 'transparent' }} width="1.5vw" height="1.5vw" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g id="24px/icon/home">
                  <path id="Vector" d="M12 2L3 9V20C3 20.5304 3.21071 21.0391 3.58579 21.4142C3.96086 21.7893 4.46957 22 5 22H19C19.5304 22 20.0391 21.7893 20.4142 21.4142C20.7893 21.0391 21 20.5304 21 20V9L12 2Z" stroke={col[0] ? '#12D576' : '#F2F2F2'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  <path id="Vector_2" d="M9 22V12H15V22" stroke={col[0] ? '#12D576' : '#F2F2F2'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </g>
              </svg>
          ...
          <Link to='/search'>
            <div className='expanded' id='sale_logo' style={{ display: 'none', marginTop: '15px' }} onClick={() => {
              ...
              <svg width='1.5vw' height='1.5vw' style={{ width: '100%', marginRight: '2px', fill: 'transparent', fill: `${col[11] ? '#12D576' : 'white'}` }} version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 296.41 296.41" xmlnsXlink="http://www.w3.org/1999/xlink" enableBackground="new 0 0 296.41 296.41">
                <g>
          ...
          <Link to='/wallet'>
            <div className='expanded' style={{ marginTop: '15px' }} onClick={() => {
              ...
              <svg style={{ width: '100%', marginRight: '2px', fill: 'transparent' }} width="1.5vw" height="1.5vw" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g id="24px/icon/user">
                  <path id="Vector" d="M20 21V19C20 17.9391 19.5786 16.9217 18.8284 16.1716C18.0783 15.4214 17.0609 15 16 15H8C6.93913 15 5.92172 15.4214 5.17157 16.1716C4.42143 16.9217 4 17.9391 4 19V21" stroke={col[1] ? '#12D576' : '#F2F2F2'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  <path id="Vector_2" d="M12 11C14.2091 11 16 9.20914 16 7C16 4.79086 14.2091 3 12 3C9.79086 3 8 4.79086 8 7C8 9.20914 9.79086 11 12 11Z" stroke={col[1] ? '#12D576' : '#F2F2F2'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </g>
              </svg>
            ...
            <div className='expanded' style={{ marginTop: '15px' }} onClick={() => {
              ...
              <svg style={{ width: '100%', marginRight: '2px', fill: 'transparent' }} width="1.5vw" height="1.5vw" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g id="24px/icon/credit-card">
                  <path id="Vector" d="M21 4H3C1.89543 4 1 4.89543 1 6V18C1 19.1046 1.89543 20 3 20H21C22.1046 20 23 19.1046 23 18V6C23 4.89543 22.1046 4 21 4Z" stroke={col[2] ? '#12D576' : '#F2F2F2'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  <path id="Vector_2" d="M1 10H23" stroke={col[2] ? '#12D576' : '#F2F2F2'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </g>
              </svg>
          ...
          <Link to='/contract'>
            <div className='expanded' style={{ marginTop: '15px' }} onClick={() => {
              ...
              <svg style={{ width: '100%', marginRight: '2px', fill: 'transparent' }} width="1.5vw" height="1.5vw" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g id="send">
                  <path id="Vector" d="M22 2L11 13" stroke={col[4] ? '#12D576' : '#F2F2F2'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  <path id="Vector_2" d="M22 2L15 22L11 13L2 9L22 2Z" stroke={col[4] ? '#12D576' : '#F2F2F2'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </g>
              </svg>
          ...
          {/* <div className='expanded' style={{ marginTop: '15px' }} onClick={() => {
            ...
            <svg style={{ width: '100%', marginRight: '2px', fill: 'transparent' }} width="1.5vw" height="1.5vw" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g id="dollar-sign">
                <path id="Vector" d="M12 1V23" stroke={col[5] ? '#12D576' : '#F2F2F2'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path id="Vector_2" d="M17 5H9.5C8.57174 5 7.6815 5.36875 7.02513 6.02513C6.36875 6.6815 6 7.57174 6 8.5C6 9.42826 6.36875 10.3185 7.02513 10.9749C7.6815 11.6313 8.57174 12 9.5 12H14.5C15.4283 12 16.3185 12.3687 16.9749 13.0251C17.6313 13.6815 18 14.5717 18 15.5C18 16.4283 17.6313 17.3185 16.9749 17.9749C16.3185 18.6313 15.4283 19 14.5 19H6" stroke={col[5] ? '#12D576' : '#F2F2F2'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              </g>
            </svg>
          ...
          <Link to='/lock'>
            <div className='expanded' style={{ marginTop: '15px' }} onClick={() => {
              ...
              <svg style={{ width: '100%', marginRight: '2px', fill: 'transparent' }} width="1.5vw" height="1.5vw" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g id="lock">
                  <path id="Vector" d="M19 11H5C3.89543 11 3 11.8954 3 13V20C3 21.1046 3.89543 22 5 22H19C20.1046 22 21 21.1046 21 20V13C21 11.8954 20.1046 11 19 11Z" stroke={col[7] ? '#12D576' : '#F2F2F2'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  <path id="Vector_2" d="M7 11V7C7 5.67392 7.52678 4.40215 8.46447 3.46447C9.40215 2.52678 10.6739 2 12 2C13.3261 2 14.5979 2.52678 15.5355 3.46447C16.4732 4.40215 17 5.67392 17 7V11" stroke={col[7] ? '#12D576' : '#F2F2F2'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </g>
              </svg>
          ...
          <div className='expanded' style={{ marginTop: '15px' }} onClick={() => {
            ...
            <svg style={{ width: '100%', marginRight: '2px', fill: 'transparent' }} width="1.5vw" height="1.5vw" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g id="life-buoy">
                <path id="Vector" d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke={col[8] ? '#12D576' : '#F2F2F2'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path id="Vector_2" d="M12 16C14.2091 16 16 14.2091 16 12C16 9.79086 14.2091 8 12 8C9.79086 8 8 9.79086 8 12C8 14.2091 9.79086 16 12 16Z" stroke={col[8] ? '#12D576' : '#F2F2F2'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path id="Vector_3" d="M4.92993 4.92993L9.16993 9.16993" stroke={col[8] ? '#12D576' : '#F2F2F2'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path id="Vector_4" d="M14.8301 14.8301L19.0701 19.0701" stroke={col[8] ? '#12D576' : '#F2F2F2'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path id="Vector_5" d="M14.8301 9.16993L19.0701 4.92993" stroke={col[8] ? '#12D576' : '#F2F2F2'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path id="Vector_6" d="M14.8301 9.16989L18.3601 5.63989" stroke={col[8] ? '#12D576' : '#F2F2F2'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path id="Vector_7" d="M4.92993 19.0701L9.16993 14.8301" stroke={col[8] ? '#12D576' : '#F2F2F2'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              </g>
            </svg>
        ...
        <div className="navbar" style={{ display: 'flex', justifyContent: 'space-between', color: `${theme === 'Dark' ? 'whitesmoke' : 'black'}`, fontWeight: "700" }}>
          <div className="navBrand" >
            <div style={{ display: 'flex', alignContent: 'center', justifyContent: 'center', alignItems: 'center', flexDirection: 'row', }}>
              <img id='logo_img' src={Icon} style={{ width: '53px', height: '46px', marginTop: '-8px', }} alt="" />
